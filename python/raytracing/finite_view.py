...
from .finite_trig_raytracing_data import *
...
__all__ = ['FiniteView', 'NonorientableUnsupportedError']
...
class FiniteView(SimpleImageShaderWidget, HyperboloidNavigation):
    def __init__(self, manifold, weights, master, *args,
        ...
        shader_source, uniform_block_names_sizes_and_offsets = (
            shaders.get_finite_triangulation_shader_source_and_ubo_descriptors(
    ...
    def _unguarded_initialize_raytracing_data(self):
        self.raytracing_data = FiniteTrigRaytracingData.from_triangulation(
            self.manifold,
